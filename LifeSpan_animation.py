...
#0 Check that plotly is installed in your environment if not install it with conda or pip
#1 Once done type the following command line: 
#python Documents/Documents_MAC/LifeSpan_animation.py
